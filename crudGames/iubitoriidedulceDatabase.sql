...
-- Descarcă structura bazei de date pentru iubitoriidedulce
CREATE DATABASE IF NOT EXISTS `iubitoriidedulce` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `iubitoriidedulce`;

-- Descarcă structura pentru tabelă iubitoriidedulce.categories
...
-- Descarcă datele pentru tabela iubitoriidedulce.categories: ~7 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.customers
...
-- Descarcă datele pentru tabela iubitoriidedulce.customers: ~7 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.failed_jobs
...
-- Descarcă datele pentru tabela iubitoriidedulce.failed_jobs: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.games
...
-- Descarcă datele pentru tabela iubitoriidedulce.games: ~2 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.image_gallery
...
-- Descarcă datele pentru tabela iubitoriidedulce.image_gallery: ~13 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.migrations
...
-- Descarcă datele pentru tabela iubitoriidedulce.migrations: ~5 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.model_has_permissions
...
-- Descarcă datele pentru tabela iubitoriidedulce.model_has_permissions: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `model_has_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `model_has_permissions` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.model_has_roles
...
-- Descarcă datele pentru tabela iubitoriidedulce.model_has_roles: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `model_has_roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `model_has_roles` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.orders
...
-- Descarcă datele pentru tabela iubitoriidedulce.orders: ~6 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.order_details
...
-- Descarcă datele pentru tabela iubitoriidedulce.order_details: ~14 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.password_resets
...
-- Descarcă datele pentru tabela iubitoriidedulce.password_resets: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.permissions
...
-- Descarcă datele pentru tabela iubitoriidedulce.permissions: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `permissions` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.products
...
-- Descarcă datele pentru tabela iubitoriidedulce.products: ~40 rows (aproximativ)
...
INSERT INTO `products` (`id`, `upc`, `product_name`, `price_each`, `weight`, `description`, `product_id`, `category`, `stock`, `thumbnail`, `brand`, `the_current_date`) VALUES
	...
	(42, '50123456789011111', 'hey', 20, '12', 'ganache', 'aaaa', 'bbbbb', 122, NULL, 'ttttttt', '2021-08-06 14:02:02'),
	(43, '123456789', 'hey there', 50, '356', 'ganache', 'SMSP200', 'bbbbb', 123, NULL, 'NestleNou', '2021-08-11 13:39:02');
/*!40000 ALTER TABLE `products` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.product_categories
...
-- Descarcă datele pentru tabela iubitoriidedulce.product_categories: ~40 rows (aproximativ)
...
-- Descarcă structura pentru tabelă iubitoriidedulce.roles
...
-- Descarcă datele pentru tabela iubitoriidedulce.roles: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.role_has_permissions
...
-- Descarcă datele pentru tabela iubitoriidedulce.role_has_permissions: ~0 rows (aproximativ)
/*!40000 ALTER TABLE `role_has_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `role_has_permissions` ENABLE KEYS */;

-- Descarcă structura pentru tabelă iubitoriidedulce.users
...
-- Descarcă datele pentru tabela iubitoriidedulce.users: ~0 rows (aproximativ)
